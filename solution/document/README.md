...
- **Log Files**: 
  - `solution/backend/logs/app.log` - Application logs
  - `solution/backend/logs/error.log` - Error logs
  - `solution/backend/logs/combined.log` - All logs combined
...
# Logging
LOG_LEVEL=info
LOG_FILE=solution/backend/logs/app.log
