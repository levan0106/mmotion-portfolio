 ...
 * Wrapper around ResponsiveButton that automatically handles read-only mode (demo account)
...
export interface ActionButtonProps extends Omit<ResponsiveButtonProps, 'disabled'> {
  /**
...
/**
 * ActionButton component that automatically handles read-only mode
 * 
 * Usage:
 * ```tsx
 * <ActionButton 
