    ...
    >
          ...
          <div className="portfolio-card__total-value">
            ...
            <div>
              <ResponsiveTypography variant="cardValue" className="portfolio-card__total-value-amount">
                {formatCurrency((Number(portfolio.totalInvestValue) + Number(portfolio.cashBalance)) || 0, portfolio.baseCurrency)}
              </ResponsiveTypography>
      ...
      {!hideActions && !isReadOnly && (
        <div className="portfolio-card__actions">
          ...
          {/* Permission Stats */}
          {permissionStats && Number(permissionStats.totalAccounts) > 0 && (
            <Box 
              display="flex" 
              alignItems="center" 
              gap={1} 
            ...
            >
              ...
              >
                {permissionStats.totalAccounts} {permissionStats.totalAccounts === 1 ? 'account' : 'accounts'}
              </ResponsiveTypography>
            </Box>
          )}
        </div>
