...
export class AssetGroupPerformanceSnapshot {
  ...
  @Column({ name: 'group_twr_1d', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupTWR1D: number;

  @Column({ name: 'group_twr_1w', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupTWR1W: number;

  @Column({ name: 'group_twr_1m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupTWR1M: number;

  @Column({ name: 'group_twr_3m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupTWR3M: number;

  @Column({ name: 'group_twr_6m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupTWR6M: number;

  @Column({ name: 'group_twr_1y', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupTWR1Y: number;

  @Column({ name: 'group_twr_ytd', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupTWRYTD: number;

  // Group Risk Metrics
  @Column({ name: 'group_sharpe_ratio_1m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupSharpeRatio1M: number;

  @Column({ name: 'group_sharpe_ratio_3m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupSharpeRatio3M: number;

  @Column({ name: 'group_sharpe_ratio_1y', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupSharpeRatio1Y: number;

  @Column({ name: 'group_volatility_1m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupVolatility1M: number;

  @Column({ name: 'group_volatility_3m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupVolatility3M: number;

  @Column({ name: 'group_volatility_1y', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupVolatility1Y: number;

  @Column({ name: 'group_max_drawdown_1m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupMaxDrawdown1M: number;

  @Column({ name: 'group_max_drawdown_3m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupMaxDrawdown3M: number;

  @Column({ name: 'group_max_drawdown_1y', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupMaxDrawdown1Y: number;

  // Group Risk-Adjusted Returns
  @Column({ name: 'group_risk_adjusted_return_1m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupRiskAdjustedReturn1M: number;

  @Column({ name: 'group_risk_adjusted_return_3m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupRiskAdjustedReturn3M: number;

  @Column({ name: 'group_risk_adjusted_return_1y', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupRiskAdjustedReturn1Y: number;

  // Group IRR (Internal Rate of Return)
  @Column({ name: 'group_irr_1m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupIRR1M: number;

  @Column({ name: 'group_irr_3m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupIRR3M: number;

  @Column({ name: 'group_irr_6m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupIRR6M: number;

  @Column({ name: 'group_irr_1y', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupIRR1Y: number;

  @Column({ name: 'group_irr_ytd', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupIRRYTD: number;

  // Group Alpha (vs Benchmark)
  @Column({ name: 'group_alpha_1m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupAlpha1M: number;

  @Column({ name: 'group_alpha_3m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupAlpha3M: number;

  @Column({ name: 'group_alpha_6m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupAlpha6M: number;

  @Column({ name: 'group_alpha_1y', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupAlpha1Y: number;

  @Column({ name: 'group_alpha_ytd', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupAlphaYTD: number;

  // Group Beta (vs Benchmark)
  @Column({ name: 'group_beta_1m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupBeta1M: number;

  @Column({ name: 'group_beta_3m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupBeta3M: number;

  @Column({ name: 'group_beta_6m', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupBeta6M: number;

  @Column({ name: 'group_beta_1y', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupBeta1Y: number;

  @Column({ name: 'group_beta_ytd', type: 'decimal', precision: 8, scale: 4, default: 0 })
  groupBetaYTD: number;
